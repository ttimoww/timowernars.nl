...
tag: Next.js
date: 2024-02-16
description: Next.js Server Actions are great, but they lack a crucial aspect of security. Learn how to protect your Server Actions with using next-server-action-validation and read about my motivation behind creating this package.
---
